...
class PositionMenu extends StatelessWidget {
  ...
  static const Map<String, IconData> roomIcons = {
    ...
    "Haus": Icons.home,
    "Garten": Icons.grass,
    "Erdgeschoss": Icons.looks_one_rounded,
    "Obergeschoss": Icons.looks_two_rounded,
    "Schlafzimmer": Icons.bed,
    "Küche": Icons.kitchen,
    "Bad": Icons.bathtub,
    "WC": Icons.wc,
    "Umkleide": Icons.checkroom_outlined,
    "Eingang": Icons.door_back_door_outlined,
    "Diele": Icons.calendar_view_day_sharp,
    "Büro": Icons.work,
    "Flur": Icons.flood,
    "Esszimmer": Icons.restaurant,
    "Kinderzimmer Blau": Icons.child_care,
    "Kinderzimmer Gelb": Icons.child_care,
