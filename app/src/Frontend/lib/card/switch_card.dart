...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490.1 490.1" xml:space="preserve">
...
''';
  ...
  Widget build(BuildContext context) {
    final Color accent = value() ? Colors.greenAccent : Colors.grey.shade600;
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: accent.withOpacity(value() ? 0.4 : 0),
            blurRadius: value() ? 20 : 0,
            spreadRadius: value() ? 4 : 0,
