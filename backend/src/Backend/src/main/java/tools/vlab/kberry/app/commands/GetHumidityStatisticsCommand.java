...
public class GetHumidityStatisticsCommand extends Command {
    ...
    public Future<Optional<JsonObject>> execute(JsonObject message) {
        ...
        return this.getStatistics().getHumidity().getToday(FloatValue.class, positionPath).compose(stat -> {
    ...
    public CommandTopic topic() {
        return Commands.GET_HUMIDITY_STATISTICS;
    }
